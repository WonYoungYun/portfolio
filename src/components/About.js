  ...
  return (
    <div id="about">
      ...
      <p className="content">
        ...
        진학했습니다. 대학 강의로 Spring을 배우는 과정에 웹페이지를 그려나가는
        것에 관심이 생겼고, 프론트엔드에 대해 공부하기 시작했습니다. HTML, CSS,
        JavaScript를 배우며 내가 생각한 것을 그대로 구현하는 것과 웹페이지들을
        분석하며 보는 것에 재미를 느꼈습니다.
